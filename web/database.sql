...
-- ============================================================
-- ============================================================
-- Catatan: Seeding akun default (admin, manager, staff)
-- dilakukan secara otomatis oleh config.php saat startup
-- menggunakan PHP password_hash() agar hash benar-benar valid.
-- ============================================================
